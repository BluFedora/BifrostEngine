...
BIFROST_DECLARE_HANDLE(VertexLayoutSet);  // TODO(SR): Maybe this should be a POD rather than a handle?
BIFROST_DECLARE_HANDLE(DescriptorSet);    // TODO(SR): Maybe this should be a POD rather than a handle?
...
BIFROST_DECLARE_HANDLE(WindowSurface);
