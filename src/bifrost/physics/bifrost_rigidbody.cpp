...
namespace prism
{
    ...
    static inline void _transformInertiaTensor(Mat3x3 &iitWorld,
                                               const Quat &q,
     ...
     */
    static inline void _calculateTransformMatrix(Mat4x3 &transformMatrix,
                                                 const Vec3 &position,
    ...
    void RigidBody::addPosition(const Vec3 &deltaPos)
    {
    ...
    void RigidBody::addVelocity(const Vec3 &deltaVel)
    {
    ...
    void RigidBody::setAcceleration(const Vec3 &accel)
    {
    ...
    void RigidBody::setOrientation(const Quat &orientiation)
    {
        this->orientation = orientiation;
    ...
    void RigidBody::addRotation(const Vec3 &deltaRot)
    {
