...
static void ImGui_ImplGlfw_CreateWindow(ImGuiViewport* viewport)
{
  ...
  //Note(Aidan) Dont even get me started on glfw, they have had support of transparent windows in their repository for 3 years
  //            now. It used to take them about half a year to put out releases, but for some reason they just got stuck on
  //            version 3.3 and are yet to release it, despite finishing all the planned milestones over a year ago.
